    ...
    <>
      ...
      <div className="flex justify-center items-center h-screen bg-blue-50">
        <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
            ...
            {isRegister ? (
              <>
                ...
                <div className="relative mb-4">
                  ...
                  <input
                    type="email"
                    className="w-full px-10 py-2 border border-blue-300 rounded-lg focus:outline-none focus:border-blue-500"
          ...
          <div className="my-6 text-center text-blue-400">or connect with</div>
